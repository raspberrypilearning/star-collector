...
![The Scene view with text saying 'Stars: 1'.](images/stars-1.png)
  ...
  ಹಾಗೆನಿಲ್ಲ. Look carefully at the text string in the code.
...
![The Scene view with text saying '"Stars:" + stars'](images/stars-full.png)
  ...
  ಹಾಗೆನಿಲ್ಲ. The letters inside double quotes `"` make a text string. The `+` operator joins strings together. When you add `+` a variable to a string, the value of the variable gets added to the string.
...
![The Scene view with text saying 'Stars:1'.](images/no-space.png)
  ...
  ಹೌದು. There is no space after the `:` in the text string in the code so there won't be one in the text that is displayed.
