...
Un GameObject coleccionable tiene configurado este box collider:
![Los límites de Box Collider en la vista de Scene.](images/star-collider.png)
![Las propiedades del componente Box Collider con Box Collider habilitado y 'Is Trigger' deshabilitado. Las coordenadas se colocan para adaptarse al coleccionable.](images/inspector-collider.png)
