...
Inicia Unity Hub y abre el proyecto que creaste para [Explora un mundo 3D](https://projects.raspberrypi.org/es-LA/projects/explore-a-3d-world){:target=blank}.
...
Si no puedes abrir tu proyecto Explora un mundo 3D, puedes descargar, descomprimir e importar este [Paquete de inicio de Coleccionista de estrellas](https://rpf.io/p/es-LA/star-collector-go){:target=blank}.
...
En [Explora un mundo 3D](https://projects.raspberrypi.org/es-LA/projects/explore-a-3d-world/){:target="_blank"} usaste `transform.Rotate` para girar al jugador. Puedes usar el mismo método para hacer girar la estrella alrededor del eje y.
...
---
    void Update()
    {
        transform.Rotate(Vector3.up * velocidadGiro); // Rotar sobre el eje y (hacia arriba)
    }
--- /code ---
