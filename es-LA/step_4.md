...
line_highlights: 7
---
public class JugadorEstrella : MonoBehaviour
{
    public int stars = 0; // Un número entero sin decimales
...
---
    ...
    {
        // Verifica la tag (etiqueta) del objeto que colisiona
        if (other.CompareTag("Player"))
        {
            JugadorEstrella player = other.gameObject.GetComponent<JugadorEstrella>();
            player.estrellas += 1; // Aumentar en 1
...
---
title: Primera vez usando el ventana emergente TextMeshPro
---
...
![Stars GameObject renombrado en la ventana Hierarchy.](images/stars-gameobject.png)
...
public class JugadorEstrella : MonoBehaviour
{
    public int estrellas = 0; // Un número entero sin decimales
    public TMP_Text textoEstrella;
    // Se llama a Start antes de la actualización del primer cuadro
--- /code ---
...
public class JugadorEstrella : MonoBehaviour
{
    ...
    void Update()
    {
        textoEstrella.SetText("Estrellas: " + estrellas);
    }
--- /code ---
...
![Texto de Estrellas seleccionado en la ventana Inspector para el jugador.](images/stars_text.png)
